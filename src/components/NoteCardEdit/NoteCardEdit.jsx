  ...
  return (
    <form className={dynamicClass}>
      <header className="NoteCard-header">
        <input
          className="NoteCard-header-title EditCard-title"
          defaultValue={title}
        />
        {/* {isPinned 
      ...
      <textarea
        className="NoteCard-content EditCard-content"
      ...
      <footer className="NoteCard-footer">
        ...
        <menu className="NoteCard-footer-manage">
          ...
          {/* <button className="NoteCard-footer-manage-button Button">
            <img src={icoEdit} className="Button-img edit" />
          </button> */}
        </menu>
      </footer>
    </form>
